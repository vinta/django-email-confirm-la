...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('email_confirm_la_emailconfirmation', (
            ...
            ('email_field_name', self.gf('django.db.models.fields.CharField')(default='email', max_length=32)),
        ...
        db.create_unique('email_confirm_la_emailconfirmation', ['content_type_id', 'email_field_name', 'object_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailConfirmation', fields ['content_type', 'email_field_name', 'object_id', 'email']
        db.delete_unique('email_confirm_la_emailconfirmation', ['content_type_id', 'email_field_name', 'object_id', 'email'])
    ...
    models = {
        ...
        'email_confirm_la.emailconfirmation': {
            'Meta': {'unique_together': "(('content_type', 'email_field_name', 'object_id', 'email'),)", 'object_name': 'EmailConfirmation'},
            'confirmation_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'email_field_name': ('django.db.models.fields.CharField', [], {'default': "'email'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
